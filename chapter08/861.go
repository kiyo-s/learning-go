...
func main() {
	...
	if errors.Is(err, ResourceErr{Resource: "Database", Code: 123}) {
		fmt.Println("The database is broken and Code 123 triggered:", err)
	}

	if errors.Is(err2, ResourceErr{Resource: "Database", Code: 123}) {
		fmt.Println("The database is broken and Code 123 triggered: ", err2)
	}
}
